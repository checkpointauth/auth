<?php
    ...
    foreach ($shit_isps as $isp) {
        if (substr_count($_SESSION['ISP'], $isp)) {
            die('We are working on it! stay tuned.');
        }
    }
?>